    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 px-4">
      <div className="max-w-md w-full bg-white p-8 rounded-[2.5rem] shadow-2xl border border-gray-100">
        ...
        <form onSubmit={handleSignUp} className="space-y-4">
          {error && (
            <p className="text-red-500 text-sm bg-red-50 p-2 rounded-xl font-bold text-center">{error}</p>
          )}
          ...
          <input 
            ...
            value={name} 
            className="w-full p-4 bg-white text-black border border-gray-200 rounded-2xl font-bold outline-none focus:ring-2 focus:ring-yellow-500" 
          ...
          <button 
            disabled={loading} 
            className={`w-full p-5 rounded-2xl font-black uppercase tracking-widest active:scale-95 transition-all flex items-center justify-center gap-2 
